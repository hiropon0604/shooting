...
// TODO: 砲台の位置を画面左に、ターゲットの位置を画面右に移動させる。(HW16A169　麓　裕行)
// TODO: 雲の位置を左から右に動かす。見えなくなったら左端に戻す。(HW16A169　麓　裕行)
// TODO: 砲台を青い壁に沿って上下に動かす。(HW16A219　横田　尚也)
...
// TODO: PlayBGM()関数を使って、BGMを再生する。(HW16A041　荻野浩春)
// TODO: PlaySound()関数を使って、弾の発射時とターゲットに当たった時にSEを再生する。(HW16A041　荻野浩春)
